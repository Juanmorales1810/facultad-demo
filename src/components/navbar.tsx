...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            navRef.current?.classList.toggle('bg-background', window.scrollY > 150);
            navRef.current?.classList.toggle('shadow-xl', window.scrollY > 150);
            navRef.current?.classList.toggle('bg-transparent', !(window.scrollY > 150));
        };
    ...
    return (
        <section>
            <div
                className="fixed top-0 z-500 w-full bg-transparent transition-all duration-500"
                ref={navRef}>
    ...
    return (
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetContent
                ...
                side="top"
                className="bg-primary text-primary-foreground inset-0 z-600 h-dvh w-full [&>button]:hidden">
                <div className="flex-1 overflow-y-auto">
                    <div className="container px-2 pb-12">
...
const renderMobileMenuItem = (item: MenuItem, index: number) => {
    return (
        <div
            ...
            <div className="text-muted-2-foreground text-xs uppercase">{item.title}</div>
