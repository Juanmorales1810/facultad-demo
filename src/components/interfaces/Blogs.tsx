...
const BlogsResult = ({ posts, categories }: BlogsResultProps) => {
    ...
    const [selectedCategories, setSelectedCategories] = useState<string[]>([CATEGORIES[0].value]);
    ...
    return (
        <section className="pb-32">
            <div className="bg-muted bg-[url('https://deifkwefumgah.cloudfront.net/shadcnblocks/block/patterns/dot-pattern-2.svg')] bg-[length:3.125rem_3.125rem] bg-repeat">
                <div className="container mx-auto flex flex-col items-start justify-start gap-16 px-4 py-20 lg:flex-row lg:items-center lg:justify-between">
